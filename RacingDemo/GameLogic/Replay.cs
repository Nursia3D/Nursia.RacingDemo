...
using RacingDemo.Helpers;
using System.IO;
using RacingDemo.Tracks;
using RacingDemo.GameScreens;
...
namespace RacingDemo.GameLogic
{
	/// <summary>
	...
	public class Replay : ICloneable
	{
		...
		public Replay(int setTrackNum, bool createNew, Track track)
		{
            ...
            try
            {
                ...
                {
                    IAsyncResult async = storageDevice.BeginOpenContainer("RacingDemo", null, null);
