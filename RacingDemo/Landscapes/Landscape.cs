...
using RacingDemo.Tracks;
using RacingDemo.Utilities;
using System;
...
namespace RacingDemo.Landscapes
{
	/// <summary>
	/// Level we use for our track and landscape
	/// </summary>
	public enum RacingDemoLevel
	{
		Beginner,
		Advanced,
		Expert,
	...
	public class Landscape : IDisposable
	{
		...
		{
			return RacingGame.Terrain.GetHeight(new Vector3(x, y, 0));
		}
		...
		/// </summary>
		RacingDemoLevel level = RacingDemoLevel.Beginner;
		...
		public SceneNode Scene
		{
			get
			{
				...
				{
					_scene.Children.Add(RacingGame.Terrain);
		...
		/// from the RacingDemo main class!
		/// </summary>
		/// <param name="setLevel">Level we want to load</param>
		public Landscape(RacingDemoLevel setLevel)
		{
		...
		internal void ReloadLevel(RacingDemoLevel setLevel)
		{
			level = setLevel;
